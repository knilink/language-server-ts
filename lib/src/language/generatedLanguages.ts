export const knownLanguages: Record<string, { extensions: string[]; filenames?: string[] }> = {
  abap: { extensions: ['.abap'] },
  aspdotnet: { extensions: ['.asax', '.ascx', '.ashx', '.asmx', '.aspx', '.axd'] },
  bat: { extensions: ['.bat', '.cmd'] },
  bibtex: { extensions: ['.bib', '.bibtex'] },
  blade: { extensions: ['.blade', '.blade.php'] },
  BluespecSystemVerilog: { extensions: ['.bsv'] },
  c: { extensions: ['.c', '.cats', '.h', '.idc'] },
  csharp: { extensions: ['.cake', '.cs', '.cs.pp', '.csx', '.linq'] },
  cpp: {
    extensions: [
      '.c++',
      '.cc',
  ...
  css: { extensions: ['.css', '.wxss'] },
  clojure: {
    extensions: ['.bb', '.boot', '.cl2', '.clj', '.cljc', '.cljs', '.cljs.hl', '.cljscm', '.cljx', '.edn', '.hic'],
    filenames: ['riemann.config'],
  },
  ql: { extensions: ['.ql', '.qll'] },
  coffeescript: { extensions: ['._coffee', '.cake', '.cjsx', '.coffee', '.iced'], filenames: ['Cakefile'] },
  cuda: { extensions: ['.cu', '.cuh'] },
  dart: { extensions: ['.dart'] },
  dockerfile: { extensions: ['.dockerfile'], filenames: ['Containerfile', 'Dockerfile'] },
  dotenv: {
    extensions: ['.env'],
    filenames: [
      '.env',
  ...
  elixir: { extensions: ['.ex', '.exs'], filenames: ['mix.lock'] },
  erlang: {
  ...
  terraform: { extensions: ['.hcl', '.nomad', '.tf', '.tfvars', '.workflow'] },
  hlsl: { extensions: ['.cginc', '.fx', '.fxh', '.hlsl', '.hlsli'] },
  erb: { extensions: ['.erb', '.erb.deface', '.rhtml'] },
  ...
  r: { extensions: ['.r', '.rd', '.rsx'], filenames: ['.Rprofile', 'expr-dist'] },
  ruby: {
    extensions: [
      '.builder',
      '.eye',
  ...
  sql: { extensions: ['.cql', '.ddl', '.inc', '.mysql', '.prc', '.sql', '.tab', '.udf', '.viw'] },
  ...
  vb: { extensions: ['.vb', '.vbhtml', '.Dsr', '.bas', '.cls', '.ctl', '.frm', '.vbs'] },
  vue: { extensions: ['.nvue', '.vue'] },
  xml: {
    extensions: [
      '.adml',
      '.admx',
  ...
  legend: { extensions: ['.pure'] },
  slang: { extensions: ['.fxc', '.hlsl', '.s', '.slang', '.slangh', '.usf', '.ush', '.vfx'] },
};
