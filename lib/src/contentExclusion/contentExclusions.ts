...
import type { DocumentEvaluateResult, TelemetryMeasurements, TelemetryProperties } from '../types';
...
import { Fetcher, FetchResponseError } from '../networking';
import { assertShape } from '../util/typebox';
import { telemetryException, telemetry, TelemetryData } from '../telemetry';
import { RepositoryManager } from '../repository/repositoryManager';
import { dirname } from '../util/uri';
