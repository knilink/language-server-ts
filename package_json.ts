export default {
  ...
  categories: ['AI', 'Chat', 'Programming Languages', 'Machine Learning'],
  keywords: [
    'ai',
    'openai',
    'codex',
  ...
  contributes: {
    commands: [
      ...
      },
      {
        ...
        enablement: 'editorTextFocus && github.copilot.activated',
        category: 'GitHub Copilot',
      },
      {
        ...
        enablement:
          'editorTextFocus && github.copilot.activated && config.editor.inlineSuggest.enabled && github.copilot.completions.enabled',
        category: 'GitHub Copilot',
      },
      {
    ...
    configuration: [
      {
        ...
        properties: {
          'github.copilot.selectedCompletionModel': {
            ...
            default: '',
            markdownDescription:
              'The currently selected completion model ID. To select from a list of available models, use the __"Change Completion Model"__ command or open the model picker from the Copilot menu. The value must be a valid model ID. An empty value indicates that the default model will be used.',
          },
          ...
          'github.copilot.inlineSuggest.enable': {
            ...
            default: true,
            deprecationMessage:
              'This setting has no effect. Please use github.copilot.editor.enableAutoCompletions instead.',
  ...
  scripts: {
    ...
    generate_languages:
      'ts-node script/generateLanguages.ts && prettier --write lib/src/language/generatedLanguages.ts',
    ...
    'test:headless':
      'npm-run-all test:lib test:agent "test:lib-e2e --ignore-scripts" test:prompt "test:lsp-client --ignore-scripts" lint',
