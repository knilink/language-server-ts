import { ProtocolRequestType, Disposable } from 'vscode-languageserver/node';
import type { GitHubToken, TokenEnvelope, AuthRecord } from '../../../lib/src/auth/types';
...
import { CopilotToken } from '../../../lib/src/auth/copilotToken';
import { CopilotAuthError } from '../../../lib/src/auth/error';
import { CopilotTokenManagerFromAuthManager } from '../../../lib/src/auth/copilotTokenManager';
